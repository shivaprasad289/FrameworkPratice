...
public class Register {
	...
	public void Verify_Register_with_existing_mailId()
	{
		...
		Assert.assertTrue(actualWarning.equals("Warning: E-Mail Address is already registered!"),"Warning message for duplicate email address is not displayed");
		driver.quit();
	...
	public void Verify_Registring_Account_without_Filling_anyDetails()
	{
		...
		Assert.assertTrue(actualPrivacyPolicy.equals("Warning: You must agree to the Privacy Policy!"),"Privicay policy warning message is not displayed");
		
		String actualFirstNameWarningMsg = driver.findElement(By.xpath("//input[@id='input-firstname']/following-sibling::div")).getText();
		Assert.assertTrue(actualFirstNameWarningMsg.equals("First Name must be between 1 and 32 characters!"),"Warning message for the first name textfield is not displayed");
		
		String actualLastNameWarningMsg = driver.findElement(By.xpath("//input[@id='input-lastname']/following-sibling::div")).getText();
		Assert.assertTrue(actualLastNameWarningMsg.equals("Last Name must be between 1 and 32 characters!"),"Warning message for the first name textfield is not displayed");
		
		String actualEmailWarningMsg = driver.findElement(By.xpath("//input[@id='input-email']/following-sibling::div")).getText();
		Assert.assertTrue(actualEmailWarningMsg.equals("E-Mail Address does not appear to be valid!"),"Warning message for the Email-id textfield is not displayed");
		
		String actualPhoneNoWarningMsg = driver.findElement(By.xpath("//input[@id='input-telephone']/following-sibling::div")).getText();
		Assert.assertTrue(actualPhoneNoWarningMsg.equals("Telephone must be between 3 and 32 characters!"),"Warning message for the Telephone textfield is not displayed");
		
		String actualInputPasswordWarningMsg = driver.findElement(By.xpath("//input[@id='input-password']/following-sibling::div")).getText();
		Assert.assertTrue(actualInputPasswordWarningMsg.equals("Password must be between 4 and 20 characters!"),"Warning message for the password textfield is not displayed");
